...
data {
  ...
  // additional annual covariate data
  matrix[1,n_years] cov_core; // annual covariate moisture in core
  array[n_strata] int<lower=0,upper=1> periphery; // identifies strata outside of the core
...
// spatial annual lagged covariate
  real BETA_lag_cov; //mean coefficient of covariate effect on annual fluctuations
  vector[n_strata] beta_lag_cov_raw; //coefficient of covariate effect on annual fluctuations
  real<lower=0> sd_beta_lag_cov; //variance of covariate effect (among strata)
  ...
  // annual core moisture covariate
  real BETA_cor_cov; //mean coefficient of covariate effect on annual fluctuations
  // vector[n_strata] beta_cor_cov_raw; //coefficient of covariate effect on annual fluctuations
  // real<lower=0> sd_beta_cor_cov; //variance of covariate effect (among strata)
...
transformed parameters {
  ...
  vector[n_strata] beta_lag_cov; //coefficient of covariate effect on annual fluctuations
...
beta_lag_cov = sd_beta_lag_cov*beta_lag_cov_raw + BETA_lag_cov;
...
for(s in 1:n_strata){
    ...
    BETA_cor_cov*cov_core[1,]*periphery[s];
