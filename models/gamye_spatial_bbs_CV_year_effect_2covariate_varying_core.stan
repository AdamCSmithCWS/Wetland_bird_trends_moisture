...
//  vector[n_strata] beta_cor_cov; //coefficient of covariate effect on annual fluctuations
...
//beta_cor_cov = sd_beta_cor_cov*beta_cor_cov_raw + BETA_cor_cov;
...
// covariate effects
  //beta_cor_cov_raw ~ icar_normal(n_strata, node1, node2); // prior for spatially varying covariate
  BETA_cor_cov ~ normal(0,1); //prior for mean covariate effect
  //sd_beta_cor_cov ~ normal(0,1); //prior on variance of covariate effect
